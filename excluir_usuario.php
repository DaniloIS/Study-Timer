<?php
	...
	if(isset($_POST['ok'])){
		...
		$rs = $con -> query("call sp_deletaUsuario($codigo);");
		...
		if(!empty($row->erro)){
			...
			?><script>location.href='sair.php';</script><?php
		}
	}if(isset($_POST['nao'])){
		?><script>location.href='conta.php';</script><?php
	}
?>
<html lang="pt_br">
<head>
        ...
        <div>
		  <form action="" method="POST" class="form-signin">
		   <label for="nome">Nome</label>
			...
			<br />
			<center>
			<input name="ok" value="Sim" type="submit" class='btn btn-danger'>
		    <input name="nao" value="Não" type="submit" class='btn btn-success'>
			</center>
			</form>
        </div>
